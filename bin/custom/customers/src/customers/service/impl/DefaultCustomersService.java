...
public class DefaultCustomersService implements CustomersService {
    private static final Logger LOG = LoggerFactory.getLogger(DefaultCustomersService.class);
    ...
    private InputStream getImageStream() {
        return DefaultCustomersService.class.getResourceAsStream("/customers/sap-hybris-platform.png");
    }
