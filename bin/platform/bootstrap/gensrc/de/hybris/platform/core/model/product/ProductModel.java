...
public class ProductModel extends ItemModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>Product.sport</code> attribute defined at extension <code>customers</code>. */
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>Product.sport</code> attribute defined at extension <code>customers</code>. 
	 * Consider using FlexibleSearchService::searchRelation for pagination support of large result sets.
	 * @return the sport
	 */
	@Accessor(qualifier = "sport", type = Accessor.Type.GETTER)
	public Collection<SportModel> getSport()
	{
	...
	/**
	 * <i>Generated method</i> - Setter of <code>Product.sport</code> attribute defined at extension <code>customers</code>. 
	 *  
	 * @param value the sport
	 */
	@Accessor(qualifier = "sport", type = Accessor.Type.SETTER)
	public void setSport(final Collection<SportModel> value)
	{
