...
public class CustomerModel extends UserModel
{
	...
	/**<i>Generated relation code constant for relation <code>Sport2Customer</code> defining source attribute <code>sports</code> in extension <code>customers</code>.</i>*/
	public static final String _SPORT2CUSTOMER = "Sport2Customer";
	...
	/** <i>Generated constant</i> - Attribute key of <code>Customer.quantityOfSport</code> attribute defined at extension <code>customers</code>. */
	public static final String QUANTITYOFSPORT = "quantityOfSport";
	
	/** <i>Generated constant</i> - Attribute key of <code>Customer.sports</code> attribute defined at extension <code>customers</code>. */
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>Customer.quantityOfSport</code> dynamic attribute defined at extension <code>customers</code>. 
	 * @return the quantityOfSport
	 */
	@Accessor(qualifier = "quantityOfSport", type = Accessor.Type.GETTER)
	public Long getQuantityOfSport()
	{
		return getPersistenceContext().getDynamicValue(this,QUANTITYOFSPORT);
	}
	
	/**
	 * <i>Generated method</i> - Getter of the <code>Customer.sports</code> attribute defined at extension <code>customers</code>. 
	 * Consider using FlexibleSearchService::searchRelation for pagination support of large result sets.
	 * @return the sports
	 */
	@Accessor(qualifier = "sports", type = Accessor.Type.GETTER)
	public Collection<SportModel> getSports()
	{
		return getPersistenceContext().getPropertyValue(SPORTS);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>Customer.sports</code> attribute defined at extension <code>customers</code>. 
	 *  
	 * @param value the sports
	 */
	@Accessor(qualifier = "sports", type = Accessor.Type.SETTER)
	public void setSports(final Collection<SportModel> value)
	{
		getPersistenceContext().setPropertyValue(SPORTS, value);
	}
